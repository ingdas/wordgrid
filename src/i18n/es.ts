...
export const es: Record<string, string> = {
  ...
  "twist.cipher.intro": "👑 Jefe — las vocales han desaparecido. ¡Lee las consonantes y luego agrúpalas!",
  "twist.memory.intro":
    "🙈 Jefe — estudia el tablero, dale la vuelta y agrupa de memoria. Tómate todo el tiempo que quieras.",
